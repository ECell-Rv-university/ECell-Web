...
const GALLERY_ITEMS: GalleryItem[] = [
  {
    ...
    description:
      "A technical hackathon bringing students and builders together to explore, build, and deploy ambitious solutions.",
    date: "18 SEP 2025",
    venue: "RV UNIVERSITY",
    src: argonyx,
  ...
  },
  {
    ...
    description:
      "A technical session bringing students together to explore emerging technologies and frameworks shaping the future.",
    date: "12 DEC 2025",
    venue: "RV UNIVERSITY",
    src: winterTechTalk,
  ...
  },
  {
    ...
    description:
      "From problem discovery to your first pitch — learn practical venture building directly from experienced founders.",
    date: "24 MAR 2026",
    venue: "RV UNIVERSITY",
  ...
  },
  {
    ...
    title: "ARGONYX 2.0",
    description:
      "Build, break and reimagine. A 36-hour sprint for visionary student creators, engineers, and designers.",
    date: "18 SEP 2026",
    venue: "RV UNIVERSITY",
    src: argonyx2,
    alt: "Argonyx 2.0",
  },
  {
    ...
    description:
      "From problem discovery to flagship summits — explore our full calendar of past hackathons and upcoming founder sessions.",
    date: "ALL EDITIONS",
    venue: "RV UNIVERSITY",
    isCta: true,
  },
...
export default function Events(): React.ReactElement {
  ...
  useEffect(() => {
    const items = itemsRef.current.filter((item): item is HTMLDivElement =>
      Boolean(item),
    );
    ...
    const opacitySetters = items.map((item) =>
      gsap.quickSetter(item, "opacity"),
    );
  ...
  return (
    <section className="events-section" ref={sectionRef} id="eventsSection">
      ...
      <div
        className="events-bg-panel"
        ref={bgPanelRef}
        style={{ position: "absolute" }}
      >
        <div
          className="events-bg-inner"
          ref={bgInnerRef}
      ...
      <div
        className="events-transition-wipe"
        ref={transitionRef}
        aria-hidden="true"
      />
          ...
          {GALLERY_ITEMS.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`events-card-media ${item.isCta ? "events-card-media--cta" : ""}`}
                >
                  {item.isCta ? (
                    <Link
                      href="/events"
                    ...
                    >
                      ...
                      <div className="events-cta-card-inner">
                        <span className="events-cta-card-badge">
                          ECELL RVU · ARCHIVE
                        </span>
                        <div className="events-cta-card-button">
                          <span>VIEW ARCHIVE</span>
                          <span
                            className="events-cta-btn-icon"
                            aria-hidden="true"
                          >
                            ↗
                          </span>
